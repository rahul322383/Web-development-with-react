...
import hrms from '../assets/hrms.png'; // image import used correctly
...
const HomePage = () => {
  ...
  // Fixed animation variants - transition must be inside the state object
  const fadeInUp = {
    initial: { opacity: 0, y: 20 },
    animate: {
      opacity: 1,
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <div className="absolute inset-0 bg-gradient-to-tr from-indigo-600/20 to-purple-600/20 mix-blend-overlay" />
                <img
                  src={hrms} // corrected src: uses the imported image
