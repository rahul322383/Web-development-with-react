...
router.get('/pending-manager', authorize('Manager', 'Admin', 'HR'), leaveController.listPendingLeaves);
router.patch('/:id/review', authorize('Manager', 'Admin', 'HR'), validate(managerDecisionSchema), leaveController.reviewLeave);
