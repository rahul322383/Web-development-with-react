...
//       ? format(parse(month.toString(), "M", new Date()), "MMMM")
//       : null;
//     return {
//       icon: CreditCard,
//       label: "Payroll",
...
//           ? {
//             key: "Net Salary",
//             value: `₹${parseFloat(netSalary).toLocaleString()}`,
//           }
//           : null,
//         month && year
...
//   if (type === "SYSTEM" && metadata.type === "EXPENSE_SUBMISSION") {
...
//         {
//           key: "Expense ID",
//           // REMOVED '#' symbol from expense ID display
//           value: metadata.expenseId ? `${metadata.expenseId}` : "N/A",
//         },
...
//           {/* Metadata details - with hover effect on each field */}
//           {metadataInfo && metadataInfo.fields.length > 0 && (
//             <div className="mb-2 p-2 bg-white/50 dark:bg-black/10 rounded-lg transition-colors">
...
//                   <div
//                     key={idx}
//                     className="flex gap-1 hover:bg-gray-100 dark:hover:bg-gray-700/50 rounded-md px-1 py-0.5 -ml-1 transition-colors cursor-default"
//                   >
    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Metadata details - with proper hover on each field */}
          {metadataInfo && metadataInfo.fields.length > 0 && (
            <div className="mb-2 p-2 bg-white/50 dark:bg-black/10 rounded-lg transition-colors">
              <div className="flex items-center gap-1.5 text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">
                <metadataInfo.icon className="w-3.5 h-3.5" />
