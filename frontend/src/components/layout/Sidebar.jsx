...
//   // Collapse state (persisted) – only relevant for desktop
//   const [isCollapsed, setIsCollapsed] = useState(() =>
//     localStorage.getItem('sidebar-collapsed') === 'true'
//   );
...
//   // Determine if we are on mobile (client‑only check, for conditional rendering)
...
//           <button
//             onClick={onClose}
//             className="absolute right-2 top-2 p-1.5 rounded-lg bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm z-50"
//             aria-label="Close sidebar"
//           >
//             <X className="h-5 w-5" />
//           </button>
