  ...
  return (
    <div className="max-w-4xl mx-auto mt-8 px-4 mb-8">
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-8 text-center relative">
          ...
          {!isEditing && (
            <button 
              className="absolute top-4 right-4 bg-white text-purple-600 px-4 py-2 rounded-lg hover:bg-gray-100 transition-colors"
              ...
              <div className="space-y-3">
                ...
                {meta?.department && (
                  <div className="flex py-2 border-b">
                    ...
                    <span className="text-gray-800">{meta.department}</span>
                  </div>
                )}
                <div className="flex py-2 border-b">
